    ...
    <section className="max-w-[1400px] mx-auto relative w-full bg-[#0B0E14] text-white mt-6 sm:mt-8 overflow-hidden select-none px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="flex mx-8 flex-col sm:flex-row items-center text-center sm:text-left gap-4 sm:gap-5">
          ...
          <div>
            { }
            <span className="text-[#D4A359] text-[11px] sm:text-sm font-semibold tracking-widest uppercase block mb-1">
        ...
        <div className="shrink-0 mx-8 w-full sm:w-auto">
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 h-11 px-6 sm:px-7 rounded-lg border border-[#D4A359]/80 bg-transparent text-[#D4A359] hover:bg-[#D4A359] hover:text-[#0A0E17] text-sm sm:text-sm font-semibold transition-all duration-200 w-full sm:w-auto cursor-pointer"
            >
