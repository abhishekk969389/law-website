...
const defaultOfficeSectionData =
  ...
  return (
    <section className="max-w-[1400px] mx-auto relative w-full bg-[#0B0E14] text-white  mt-8 sm:mt-10 md:mt-12 lg:mt-14 overflow-hidden select-none px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        { }
        <div className="lg:col-span-6 space-y-6 text-center md:text-left flex flex-col items-center md:items-start">
          { }
          {tagline && (
          ...
          <FadeIn direction="up" delay={0.25}>
            <div className="w-12 h-[2px] bg-[#D4A359] mb-5 relative flex items-center justify-center mx-auto md:mx-0">
          ...
          {description && (
            <FadeIn direction="up" delay={0.3}>
              <p className="text-slate-300 text-sm sm:text-base leading-relaxed max-w-lg mb-8 text-center md:text-left">
                {description}
              </p>
            </FadeIn>
          )}
                    ...
                    <StaggerItem>
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className="text-slate-400 text-sm sm:text-sm font-medium mt-1 block">
                            {stat.label}
                          </span>
                        </div>
                      </div>
          ...
          <div className="relative rounded-2xl border border-slate-800/80 bg-[#070A11] p-8 sm:p-10 overflow-hidden shadow-2xl min-h-[380px] sm:min-h-[440px] flex flex-col justify-between group hover:border-[#D4A359]/40 transition-all duration-300">
            ...
            <div className="relative">
              ...
              <p className="font-serif italic text-white text-2xl leading-relaxed max-w-[320px] sm:max-w-[350px]">
                {quote ||
                  "Delivering excellence in legal advice and representation across India."}
              </p>
