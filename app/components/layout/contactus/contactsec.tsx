    ...
    <section className="relative w-full bg-[#0B0E14] text-white  mt-8 sm:mt-10 md:mt-12 lg:mt-14 overflow-hidden select-none px-4 sm:px-6 lg:px-8">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          {/* Card 1: Visit Us */}
          <div className="group relative rounded-2xl border border-slate-800/80 bg-[#0A0E17] p-8 sm:p-10 flex flex-col items-center text-center hover:border-[#D4A359]/50 transition-all duration-300 shadow-xl min-h-[360px] justify-start">
            
            {/* Gold Map Pin Circle Icon */}
            <div className="w-16 h-16 sm:w-18 sm:h-18 rounded-full border border-[#D4A359]/60 flex items-center justify-center bg-[#070B12] text-[#D4A359] mb-5 shrink-0 shadow-[0_0_15px_rgba(212,163,89,0.15)] group-hover:scale-105 transition-transform">
