...
import { CareerCtaData, GlobalLawData } from "@/app/data";
      ...
      >
        ...
        <div className="flex flex-col mx-8 sm:flex-row items-center gap-4 sm:gap-6 shrink-0 w-full sm:w-auto justify-center">
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <div className="inline-flex items-center justify-center gap-2 h-10 sm:h-11 px-5 sm:px-6 rounded-lg  text-[#D4A359] text-sm sm:text-sm font-semibold transition-all duration-200 w-full sm:w-auto">
