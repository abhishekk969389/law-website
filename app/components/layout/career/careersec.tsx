              ...
              <StaggerItem key={item.id}>
                ...
                >
                  <motion.div
                    ...
                    className="group relative rounded-2xl border border-slate-800/80 bg-[#0A0E17] p-4 overflow-hidden hover:border-[#D4A359]/50 transition-colors duration-300 shadow-xl flex flex-col justify-start sm:justify-between min-h-0 sm:min-h-[300px] cursor-pointer h-full"
                  >
                    ...
                    <div>
                      <div className="flex items-start gap-3.5 sm:gap-4 mb-3 sm:mb-4 pr-14 sm:pr-16">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="flex items-center gap-1.5 text-slate-400 text-sm sm:text-sm mt-1 font-medium">
                      ...
                      <p className="text-slate-400 text-sm sm:text-sm leading-relaxed mt-2.5 mb-4 sm:my-4 flex-1 line-clamp-3">
                        {item.description}
                      </p>
                    </div>

                    <div className="pt-0 sm:pt-2">
                      <div className="inline-flex items-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 rounded-lg bg-[#B87B1D]/50 text-white text-sm sm:text-sm font-semibold transition-all duration-200 w-fit shadow-md group-hover:bg-[#D4A359] group-hover:text-[#0A0E17]">
                        <span>Apply Now</span>
