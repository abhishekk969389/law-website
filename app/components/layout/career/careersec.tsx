  ...
  return (
    <section className="relative w-full bg-[#0B0E14] text-white mt-8 sm:mt-10 md:mt-12 lg:mt-14 overflow-hidden select-none px-4 sm:px-6 lg:px-8">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="text-left max-w-3xl mb-4 sm:mb-5">
          {/* Main Heading */}
          <h2 className="font-serif text-3xl md:text-4xl leading-[1.15] tracking-tight text-white mb-3">
          ...
          {items &&
            items.map((item) => {
              ...
              return (
                <div
                  key={item.id}
                  className="group relative rounded-2xl border border-slate-800/80 bg-[#0A0E17] p-6 sm:p-7 overflow-hidden hover:border-[#D4A359]/50 transition-all duration-300 shadow-xl flex flex-col justify-between min-h-[300px]"
                >
