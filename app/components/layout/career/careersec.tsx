                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="flex items-start gap-3.5 sm:gap-4 mb-3 sm:mb-4 pr-14 sm:pr-16">
                          {/* Icon Box */}
                          <div
                            className="w-11 h-11 sm:w-14 sm:h-14 rounded-xl border border-slate-800 bg-[#060911] flex items-center justify-center shrink-0 shadow-md group-hover:border-[#D4A359]/50 transition-colors"
                          >
                      ...
                      <div className="pt-0 sm:pt-2">
                        <div
                          className="inline-flex items-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 rounded-lg bg-[#B87B1D]/50 text-white text-xs sm:text-sm font-semibold transition-all duration-200 w-fit shadow-md group-hover:bg-[#D4A359] group-hover:text-[#0A0E17]"
                        >
                          <span>Apply Now</span>
