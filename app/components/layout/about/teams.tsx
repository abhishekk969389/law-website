  ...
  return (
    <section className="relative w-full text-white mt-8 sm:mt-10 md:mt-12 lg:mt-14 overflow-hidden select-none">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Section Header */}
        <div className="text-center max-w-4xl mx-auto mb-8 sm:mb-8 md:mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-6 lg:gap-6">
          {members &&
            members.map((member) => (
              <div
                key={member.id}
                className="group relative bg-[#0E131C] border border-slate-800/80 rounded-2xl overflow-hidden shadow-xl hover:border-[#D4A359]/60 hover:bg-[#121824] transition-all duration-300 flex flex-col cursor-pointer"
              >
