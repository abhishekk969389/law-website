...
const defaultTeamData =
  lawData.categories.Veritas.sections.Team?.variants?.VeritasTeam1?.team;
    ...
    <section className="relative w-full text-white mt-8 sm:mt-10 md:mt-12 lg:mt-14 overflow-hidden select-none">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <StaggerContainer
          ...
          delayChildren={0.2}
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-6 lg:gap-6"
        >
          {members &&
            members.map((member: any) => (
              <StaggerItem key={member.id}>
                ...
                >
                  <Link
                    href={member.linkHref || `/team/${member.id}`}
