          ...
          {items &&
            items.map((item) => {
              ...
              return (
                <div
                  key={item.id}
                  className="group relative rounded-2xl border border-slate-800/80 bg-[#0A0E17] p-6 sm:p-7 flex flex-col justify-between hover:border-[#D4A359]/50 transition-all duration-300 shadow-xl min-h-[250px]"
                >
                  {/* Top Circle Icon Container */}
                  <div>
                    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-full border border-[#D4A359]/60 flex items-center justify-center mb-5 bg-[#070B12] group-hover:scale-105 transition-transform shrink-0 shadow-[0_0_12px_rgba(212,163,89,0.12)]">
