...
import { LegalDisclaimerSectionData, GlobalLawData } from "@/app/data";
import {
  FadeIn,
  StaggerContainer,
  StaggerItem,
...
const defaultLegalDisclaimerSectionData =
  lawData.categories.Veritas.sections.LegalDisclaimer?.variants
    ?.VeritasLegalDisclaimer1?.legalDisclaimerSection;
...
export function Section({
  data = defaultLegalDisclaimerSectionData,
}: SectionProps) {
