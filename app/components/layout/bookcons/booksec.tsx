...
const defaultBookSectionData =
  lawData.categories.Veritas.sections.Consultation?.variants
    ?.VeritasConsultation1?.bookSection;
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                  <div>
                    ...
                    <input
                      ...
                      required
                      placeholder={
                        form?.firstNamePlaceholder || "Enter your first name"
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      placeholder={
                        form?.lastNamePlaceholder || "Enter your last name"
                      }
                      className="w-full rounded-lg border border-slate-800 bg-[#060911] px-4 py-3 text-white placeholder-slate-500 text-sm focus:border-[#D4A359]/70 outline-none transition-colors"
                    />
                  </div>
                ...
                <div>
                  ...
                  >
                    <option
                      value=""
                      disabled
                      className="bg-[#060911] text-slate-400"
                    >
                    ...
                    {practiceAreas &&
                      practiceAreas.map((area: any, idx: any) => (
                        <option
                          key={idx}
                          value={area}
                          className="bg-[#060911] text-white"
                        >
                          {area}
                        </option>
                      ))}
                ...
                <div>
                  ...
                  >
                    <option
                      ...
                      className="bg-[#060911] text-slate-400"
                    >
                      {form?.consultationTypePlaceholder ||
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      placeholder={
                        ...
                        "Share details about your case or legal concern"
                      }
                ...
                <div className="flex items-start gap-2.5 pt-1">
                  ...
                  >
                    ...
                    <Link
                      href={form?.privacyPolicyUrl || "/privacy"}
                      className="text-[#D4A359] hover:underline font-medium"
                    >
                      {form?.privacyPolicyText || "Privacy Policy"}
                    </Link>{" "}
                    and{" "}
                    <Link
                      href={form?.termsServiceUrl || "/terms"}
                      className="text-[#D4A359] hover:underline font-medium"
                    >
                ...
                <div className="pt-2">
                  ...
                  >
                    <span>
                      {form?.submitButtonText || "Book My Consultation"}
                    </span>
