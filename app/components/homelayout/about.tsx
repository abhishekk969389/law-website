            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-6 md:mb-8 gap-6">
                    ...
                    <div>
                        ...
                        {/* Main Heading */}
                        <h2 className="font-serif text-4xl sm:text-5xl lg:text-[56px] leading-[1.15] tracking-tight">
                    ...
                    <div className="flex items-center gap-6 lg:gap-8 max-w-lg shrink-0">
                        {/* Circular Seal Stamp Image from JSON */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
                    ...
                    <div className="lg:col-span-5 relative pb-8">
                        ...
                        <div className="relative border border-[#D4A359]/40 rounded-[30px] p-1.5 bg-[#0B0E14] shadow-2xl">
                            ...
                            <div className="relative rounded-[24px] overflow-hidden">
                                <Image
                                    ...
                                    width={700}
                                    height={550}
                                    className="w-full h-[320px] sm:h-[390px] lg:h-[420px] object-cover transition-transform duration-500 hover:scale-105"
                                    priority
                                />
                            ...
                            <div className="absolute -bottom-8 left-6 z-20 bg-gradient-to-b from-[#141B26] to-[#0A0D14] border border-[#D4A359]/30 rounded-[22px] px-6 py-4 flex items-center gap-5 shadow-[0_20px_40px_rgba(0,0,0,0.95)]">
                    ...
                    <div className="lg:col-span-7 flex flex-col justify-center">
                        ...
                        {/* Section Tagline */}
                        <span className="text-[#D4A359] text-xs md:text-lg font-semibold tracking-wider uppercase mb-3">
                            {foundation.subTagline}
                        </span>

                        {/* Section Heading */}
                        <h3 className="font-serif text-3xl sm:text-4xl lg:text-[42px] leading-tight mb-6">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 relative">
                            {foundation.items.map((item, idx) => {
                                const IconComp = foundationIconMap[item.icon.toLowerCase()] || ShieldCheck;

                                return (
                                    <div key={item.id || idx} className="relative lg:pr-4">
                                        ...
                                        {/* Icon Badge */}
                                        <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#131C1B] border border-[#1F302D] flex items-center justify-center text-[#D4A359] mb-4 shadow-sm group hover:border-[#D4A359]/50 transition-colors">
