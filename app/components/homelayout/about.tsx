      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-6 md:mb-8 gap-6">
          <FadeIn direction="up" delay={0.1}>
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <div className="flex items-center gap-3 mb-2 justify-center md:justify-start">
                <span className="text-[#D4A359] mt-2 text-xs md:text-lg font-semibold tracking-widest ">
                  {subTagline}
                </span>
          ...
          <FadeIn
            direction="left"
            delay={0.2}
            className="flex flex-col md:flex-row items-center gap-4 md:gap-6 lg:gap-8 max-w-lg shrink-0 text-center md:text-left"
          >
            <motion.div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center text-center md:text-left items-center md:items-start">
            ...
            <FadeIn direction="up" delay={0.2}>
              <span className="text-[#D4A359] text-xs md:text-lg font-semibold tracking-wider uppercase mb-3 block text-center md:text-left">
