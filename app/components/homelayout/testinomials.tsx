...
const defaultTestimonialsData: TestimonialsData = lawData.categories.Veritas
  .sections.Testimonials?.variants?.VeritasTestimonials1?.testimonials || {
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <FadeIn
            direction="right"
            delay={0.1}
            className="lg:col-span-5 relative pr-4 lg:pr-6"
          >
