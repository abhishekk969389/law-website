...
export default function Counting({ data = defaultCountingData, className = "" }: CountingProps) {
  return (
    <section className={`w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 mt-8 sm:mt-10 md:mt-12 lg:mt-14 ${className}`}>
      <div className="w-full bg-[#0E121A]/90 border border-white/10 rounded-2xl px-4 py-4 sm:px-6 sm:py-5 backdrop-blur-md shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-0 divide-y md:divide-y-0 lg:divide-x divide-white/10">
          {data.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col items-center mb-1.5 group">
                  <div className="text-[#F3A812] transition-transform duration-300 group-hover:scale-110 drop-shadow-[0_2px_8px_rgba(243,168,18,0.25)]">
