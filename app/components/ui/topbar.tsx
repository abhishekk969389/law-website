    ...
    return (
        <div className="w-full bg-[#0B0E14] text-slate-300 border-b border-slate-800/60 text-xs md:text-[13px] font-medium selection:bg-amber-500/30">
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-2 md:py-2.5 flex items-center justify-between gap-x-4 md:gap-x-6">
                ...
                {/* Left Side: Address (lg+), Phone (All), Email (md+) */}
                <div className="flex items-center gap-x-4 lg:gap-6 xl:gap-8">
                    {/* Address - Only on lg (1024px+) where there is enough width */}
                    {address && (
                ...
                {/* Right Side: Working Hours (md+) & Social Icons (All) */}
                <div className="flex items-center gap-x-4 lg:gap-6 xl:gap-8">
                    {/* Working Hours - md screens and up */}
                    {workingHours && (
                                ...
                                return (
                                    ...
                                    >
                                        {platformLower === "linkedin" && (
                                            <span className="font-bold text-base md:text-lg leading-none font-serif tracking-tighter">in</span>
                                        )}
                                        {platformLower === "facebook" && (
                                            <span className="font-bold text-base md:text-lg leading-none font-serif">f</span>
                                        )}
