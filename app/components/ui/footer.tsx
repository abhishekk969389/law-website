...
const defaultFooterData: FooterData = lawData.categories.Veritas.sections.Footer?.variants?.VeritasFooter1?.footer as FooterData;
  ...
  return (
    <footer className="relative w-full bg-[#0C191B] text-white pt-6 md:pt-8 overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <FadeIn direction="up" delay={0.1} className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-7 border-b border-white/10">
          <div>
        ...
        <StaggerContainer staggerChildren={0.1} delayChildren={0.2} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-6 py-7">
