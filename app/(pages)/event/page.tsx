...
export default function EventPage() {
  ...
  const eventSubBannerData = lawData.categories.Veritas.sections.PageBanner?.variants?.VeritasPageBanner1?.eventSubBanner;
  const eventSectionData = lawData.categories.Veritas.sections.Events?.variants?.VeritasEvents1?.eventSection;
